      ...
      <header className="relative overflow-hidden bg-gradient-to-b from-clinic-teal to-white pt-16 pb-32">
        <nav className="container mx-auto px-6 flex justify-between items-center mb-16">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-slate-800">Erika IA</span>
          </div>
          <button 
            onClick={onStart}
        ...
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 mb-6 leading-tight">
            ...
            <span className="text-teal-500">Automatizada con Erika IA</span>
          </h1>
          <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto">
            Gestiona tus citas por WhatsApp de forma inteligente. Erika atiende a tus pacientes 24/7, agenda citas y envía recordatorios automáticos.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100">
              ...
              <p className="text-slate-600">Erika responde dudas y gestiona conversaciones naturales por WhatsApp.</p>
            </div>
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100">
              <div className="w-12 h-12 bg-teal-100 rounded-lg flex items-center justify-center mb-6">
